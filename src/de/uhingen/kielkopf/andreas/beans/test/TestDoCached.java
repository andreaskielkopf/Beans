...
public class TestDoCached {
   ...
   public static void main(String[] args) throws InterruptedException {
      ...
      System.out.println(DoCached.getFirstOr("whoami", "5", "Fehlermeldung von whoami 5 ;-)"));
      System.out.println(DoCached.getFirstOr("whoa%i", "Ein solches Programm gibt es nicht"));
      System.out.println(DoCached.getFirstOr("whoa_i", "Ein solches Programm gibt es nicht"));
      System.out.println(DoCached.getFirstOr("whoa i", "Ein solches Programm gibt es nicht"));
      System.out.println(DoCached.getFirstOr("-c", "whoami", "kein Fehler ;-)")); // mit shell
      System.out.println("n: " + DoCached.getFirstOr(List.of("/bin/sh", "-c", "echo ${SHELL}"), "nothing"));
      ...
      DoCached.doCmd("ls", "-lA", "/home"); // cmd + parameter
      DoCached.doCmd("ls -lA /home"); // cmd + parameter
      DoCached.doCmd("ls -lA /hom*"); // cmd + parameter mit glob OK
      DoCached.doCmd("ls", "-lA", "/hom*"); // cmd + parameter mit glob geht nicht !!!
      DoCached.doCmd("-c", "ls -lA /hom*"); // cmd + parameter mit glob per shell "-c"
      DoCached.doCmd(DoCached.SHELL, "-c", "ls -lA /hom*"); // cmd + parameter mit glob per shell "-c"
      DoCached.doCmd("ls", "-lA", "/home", "/home/andreas"); // cmd + 3 parameter
      DoCached.doCmd("ls -lA /home /home/andreas"); // cmd + 3 parameter
      DoCached.doCmd("ls -lA /;ls -lA /home"); //
      ...
      Thread.sleep(1000);
      // final var q2=DoCached.doGetQueues("ls -lA /sys;sleep 10;ls -lA /root;ls -lA /home|grep -o '^[drwx-]*'");
      ...
      // });
      // final var q=DoCached.doGetQueues("ls -lA /home;sleep 3;Fehler;sleep 1;echo 'weiter nach Fehler';sleep 15;ls -lA /home");
      ...
      // System.out.println("++++++++++++");
      // System.out.println("Das ist ein Testprogramm das teils absichtlich Fehler provoziert");
      Thread.sleep(DoCached.defaultCacheMs.get()); // Damit wir sehen wie der cache sich leert
   }
}
